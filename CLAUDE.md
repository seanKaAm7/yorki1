...
- 장르: 캐리커처 화가 감성 시뮬레이션
- 기획 문서: `GAME_PLAN.md`
- 기술 문서: `SCENE_A_TECH.md`
- 진행 현황: `PROGRESS.md`
- 유지보수 문서: `MAINTENANCE_PLAN.md`
- 보존 레퍼런스: `레퍼런스_SuperPaperMario_interludes.md`, `역재 컷 활용 정보.md`

## 7. 세션 시작 시 자동 로드
새 대화 시작 시 다음 파일들이 자동 로드됩니다.
@GAME_PLAN.md
@SCENE_A_TECH.md
@PROGRESS.md
@MAINTENANCE_PLAN.md
...
## 6. 현재 구현 상태
- TalkScene.unity — 손님 대화 씬
  - 배경, 손님 캐릭터, FadeIn, 9-slice 대화창
  - TalkSceneController: PreDraw / ResultGood / ResultBad 대사 페이즈, 타이핑 출력, ▼ 깜빡임
  - CustomerDisplay: 대사별 컷 전환, 제한된 말하기 프레임, Shake 연출
- SceneA.unity — 오른쪽 반칸 드로잉 UI 씬
  - ui_fixed 기반 작업대, 종이 위 DrawingCanvas, 도구 버튼, THICKNESS, 팔레트, RGB 컬러 박스, Undo/Redo/Reset/Submit
- 드로잉 캔버스 (DrawingCanvas.cs) — 마우스 드로잉, Undo/Redo, 지우개, 색상 변경, 투명 배경, 제출용 흰 배경 합성
